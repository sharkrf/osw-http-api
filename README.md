...
- Now we HTTP POST http://openspot2.local/login this JSON:
	...
	If the password in the digest is not matching, openSPOT2 will respond
...
openSPOT2 sends this message if there's a message which should be displayed to
